...
function M.parse(arg)
   ...
   cmd:option('-showBar',         false, 'display progress bar')
   cmd:option('-saveModel',       false,  'save model to file after each epoch' )
   ...
   opt.save = paths.concat(opt.cache, 
                           ...
                           {cache=true, data=true, dataset=true, netType=true, 
                            ...
                            resetClassifier=true,shareGradInput=true,tenCrop=true,testOnly=true}))
